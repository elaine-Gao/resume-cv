...
\mobile{(+61) 0491 727 081}
\email{gao.elaine164@gmail.com}
% \homepage{www.posquit0.com}
% \github{posquit0}
\linkedin{www.linkedin.com/in/elaine-gao}
% \gitlab{gitlab-id}
% \stackoverflow{SO-id}{SO-name}
% \twitter{@twit}
% \skype{skype-id}
% \reddit{reddit-id}
\extrainfo{Citizenship: New Zealand}
...
\makecvfooter
  {\today}
%   {Ya Elaine Gao~~~·~~~Curriculum Vitae}
  {Ya Elaine Gao}
  {\thepage}
